...
function TheatreForm({
  ...
  return (
    <Modal
      title={formType === "add" ? "Προσθήκη Θεάτρου " : "Επεξεργασία Θεάτρου "}
    ...
    >
      ...
      >
        <Form.Item
          label="Name"
          name="name"
          rules={[{ required: true, message: "Ονομα Θεάτρου" }]}
        >
          <input type="text" />
        </Form.Item>
        ...
        <Form.Item
          label="Address"
          name="address"
          rules={[{ required: true, message: "Οδός" }]}
        >
          <textarea type="text" />
        </Form.Item>
        ...
        <Form.Item
          label="Email"
          name="email"
          rules={[{ required: true, message: "Διευθυνση email!" }]}
        >
          <input type="text" />
        </Form.Item>
